...
/**
 * 문제 4. 직원의 managerId가 없으면 "CEO"를 반환하라.
 * 요구 리턴 타입: String
 */
public class Optional04ManagerIdOrDefault {
    public static String solve(Employee employee) {
    ...
    public static void main(String[] args) {
        System.out.println(solve(SampleData.employees().get(3)));
    }
}
