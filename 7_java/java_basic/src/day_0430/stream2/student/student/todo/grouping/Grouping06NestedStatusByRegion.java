...
/**
 * 문제 6. 지역별로 다시 주문 상태별 그룹을 만들라.
 * 요구 리턴 타입: Map<String, Map<String, List<Order>>>
 */
public class Grouping06NestedStatusByRegion {
    public static Map<String, Map<String, List<Order>>> solve() {
