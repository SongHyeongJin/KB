package student.todo.collecting;
...
/**
 * 문제 6. 재고 있는 상품을 수정 불가능한 List로 수집하라.
 * 요구 리턴 타입: List<Product>
 */
public class Collecting06ToUnmodifiableList {
    public static List<Product> solve() {
