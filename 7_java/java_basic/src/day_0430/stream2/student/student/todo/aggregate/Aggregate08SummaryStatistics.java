package student.todo.aggregate;
...
/**
 * 문제 8. 주문 금액 IntSummaryStatistics를 구하라.
 * 요구 리턴 타입: IntSummaryStatistics
 */
public class Aggregate08SummaryStatistics {
    public static IntSummaryStatistics solve() {
