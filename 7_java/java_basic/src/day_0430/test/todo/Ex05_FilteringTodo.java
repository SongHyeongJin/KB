...
import day_0430.test.todo.common.Product;
...
public class Ex05_FilteringTodo {
    public static void main(String[] args) {
        ...
        products.stream().filter(product -> product.getStock()>=1).forEach(System.out::println);
        System.out.println();
        // TODO 2: 카테고리가 PC인 상품만 출력하세요.
        products.stream().filter(product -> (product.getCategory()).equals("PC")).forEach(System.out::println);
        System.out.println();
