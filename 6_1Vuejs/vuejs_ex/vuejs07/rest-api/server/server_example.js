// 1. 서버 구성
// Express 서버로 JSON파일(data.json)을 직접 읽고/쓰면서 (Create, Read, Update, Delete)기능 구현
// data.json => 데이터베이스를 대신함

const express = require('express'); //express 모듈 가져오기 웹서버를 쉽게 만들수 있게 제공하는 Nodejs 프레임워크
const fs = require('fs/promises'); //파일 읽기/ 쓰기 기능을 promise 기반으로 사용할 수 있게 제공해주는 라이브러리
...
//C:\KB_Workspace\오후수업\6_1Vuejs\vuejs_ex\vuejs07\rest-api\server\data.json
...
// Delete : /pai/data/:id => 특정 id의 데이터 삭제
