<!-- 이벤트 리스너를 이용한 사용자 입력 처리
 HTML 태그가 발생시키는 이벤트를 캡처하여 지정된 스크립트를 수행하거나
 함수를 호출하기 위해 v-on 디렉티브를 사용한다.
 사용자가 버튼을 클릭했을 때 click 이벤트를 발생한다.
...
export default {
  ...
  setup() {
    // ref 함수를 통해 선언된 변수는 프록시객체로 변환되어 관리된다.
    let counter = ref(0);
